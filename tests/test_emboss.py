...
##################################################
## Project: test_emboss.py
## Date: Feb 8th, 2019
## Author: Gilbert Lei, Jielin Yu, Olivia Lin
## Purpose: This scripts is an unit test for the emboss.py function
##
## Example: python tests/test_emboss.py
##################################################
...
exp_output = np.array([[[144,144,144],[141,141,141],[135,135,135],[1,1,1]],
                       [[143,143,143],[138,138,138],[128,128,128],[3,3,3]],
                       [[129,129,129],[127,127,127],[135,135,135],[3,3,3]],
